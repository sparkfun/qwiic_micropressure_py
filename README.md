...
```sh
mprmeote mip install github:sparkfun/qwiic_micropressure_py@examples
```
...
See the examples directory for more detailed use examples and [examples/README.md](https://github.com/sparkfun/qwiic_micropressure_py/blob/main/examples/README.md) for a summary of the available examples.
